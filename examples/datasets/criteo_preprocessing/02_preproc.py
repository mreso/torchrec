...
def process_criteo_day(input_path, output_path, day):
    ...
    target_dtypes = {c: np.float32 for c in DEFAULT_COLUMN_NAMES[:14] + [DEFAULT_LABEL_NAME]}
...
if __name__ == '__main__':
    ...
    assert os.path.exists(input_path), f'Criteo parquet path {input_path} does not exist'
