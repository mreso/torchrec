...
def parse_args():
    ...
    parser.add_argument('--output_base_path', '-o', dest='output_base_path', help='Output base path')
...
if __name__ == '__main__':
    ...
    print(f'Conversion from tsv to parquet took {time.time()-start_time} sec')
