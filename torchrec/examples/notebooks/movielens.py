...
def _join_with_movies(datapipe: IterDataPipe, root: str) -> IterDataPipe:
    ...
    movies_datapipe = S3FileLoader((movies_path,))
    movies_datapipe = LoadWithTextIOWrapper(movies_datapipe)
...
def _movielens(
    ...
    **open_kw,
    ...
    datapipe = S3FileLoader((ratings_path,), **open_kw)
    datapipe = LoadWithTextIOWrapper(datapipe)
